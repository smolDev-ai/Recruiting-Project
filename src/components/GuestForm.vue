  ...
  >
    ...
    <b-form v-else @submit.prevent="update">
      ...
      <b-input
        ...
        name="guestTickets"
      />
      <b-button class="mr-2" variant="primary" type="submit"
        >Update Guest</b-button
      >
      <b-button class="mr-2" variant="danger" type="reset" @click="cancel"
